            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                AppExecutors.getInstance().diskIO().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // get all Tasks
                        List<TaskEntry> list1 = mAdapter.getTasks();
                        // get a position of 1 task
                        int position1 = viewHolder.getAdapterPosition();
                        // get the ONE task
                        TaskEntry taskToDelete = list1.get(position1);

                        // delete the ONE Task
                        appDatabase1.taskDao().deleteTask( taskToDelete );
...
//                getTasksFromDatabase();
    ...
    protected void onResume() {
        ...
        // Qry the database on "onResume()" so you don't have to re-create Main Activity
        // to see the newly added task
        // qry the database
